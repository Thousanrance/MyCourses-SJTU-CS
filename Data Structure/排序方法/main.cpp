...
//快速排序-------------------------------------------------------------------------------------------------------------------------------------------------
template <class KEY, class OTHER>
int divide(SET<KEY, OTHER> a[], int low, int high) //划分函数
{
...
//堆排序---------------------------------------------------------------------------------------------------------------------------------------------------
template <class KEY, class OTHER>
void percolateDown(SET<KEY, OTHER> a[], int hole, int size) //向下过滤函数
{
    int child;
...
//归并排序------------------------------------------------------------------------------------------------------------------------------------------------
template <class KEY, class OTHER>
void merge(SET<KEY, OTHER> a[], int left, int mid, int right) //归并两个有序序列
{
    ...
    while(i<mid) //前半部分没有结束
    {
        tmp[k++] = a[i++];
    }
    while(j<=right) //后半部分没有结束
    {
        tmp[k++] = a[j++];
    }
...
template <class KEY, class OTHER>
void mergeSort(SET<KEY, OTHER> a[], int size) //包裹函数
{
